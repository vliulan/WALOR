...
pub static mut is_ssd: bool = false;    // wyy add
...
impl Peer {
	...
	// wyy add
	let mut raft_election_timeout_ticks :usize = cfg.raft_election_timeout_ticks;
        unsafe {
            if(is_ssd) {
                println!("is_ssd");
                raft_election_timeout_ticks = 5;
            }
        }
        println!("raft_election_timeout_ticks : {:?}", raft_election_timeout_ticks);
        ...
        let raft_cfg = raft::Config {
            id: peer_id,
            peers: vec![],
            election_tick: raft_election_timeout_ticks,  // wyy change cfg.raft_election_timeout_ticks to raft_election_timeout_ticks
